...
static int g_haveWhiteLed = 0;
static int g_wimax = 0;
static int g_func = 0;

char const*const GREEN_LED_FILE = "/sys/class/leds/green/brightness";
char const*const WHITE_LED_FILE = "/sys/class/leds/white/brightness";
char const*const BUTTON_FILE = "/sys/class/leds/button-backlight/brightness";
char const*const WHITE_BLINK_FILE = "/sys/class/leds/white/blink";
